                        ...
                        return(
                            <ul key={todo.id} className="todoList--font" >
                                <li className="todoList--li">
                                    ...
                                    {title==="TO-DO"&& <span className="material-icons "
                                                             onClick={() => removeTodo(todo.id)}
                                    >radio_button_unchecked</span>}
                                    {title==="DONE"&&<span className="material-icons">check_circle_outline</span>}

                                    <span >{todo.do}</span>

                                    {title==="TO-DO"&&<span className="material-icons  playIcon"
                                    >play_circle_outline
                                    </span>}
                                    { title==="DONE"&&<span className="item--cycleIcon">{handleDot(todo.number)}</span>}
